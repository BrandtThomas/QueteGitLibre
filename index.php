                ...
                if($_SESSION['username'] !== ""){
                    ...
                    <form class="container mb-3" method="POST" action="index.php">
                        <div class="row justify-content-between">
                            ...
                            Bonjour <?php echo $user; ?> , vous êtes connecté
                            </div>
                            <div>
...
<?php 
    if (isset($_POST['filmButtonAdd'])){
        ...
        <div class="alert alert-danger text-center" role="alert">
            Merci de sélectionner un studio
            </div><br>    
        <?php
        }
    else {
        ...
        if($_POST['username'] !== "" && $_POST['password'] !== "")
        {
            ...
            if($count > 0) // nom d'utilisateur et mot de passe correctes
            {
               ...
               <div class="alert alert-success text-center mt-5 pt-5" role="alert">
                Bonjour <?php echo $_SESSION['username'];?> , Vous êtes connecté. <a href="index.php">Cliquez ici</a> pour retrouver tous vos films !
               </div>
               </section>
               <?php
            }
